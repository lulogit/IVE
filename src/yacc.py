...
def p_condition6(t):
    '''condition     : QUERY ID COLON XPATH
        ...
        | QUERY ID'''
    print("condition_6")
    conds.check_name(t[2]) or halt("Invalid condition name: %s" % t[2], t.lexer.lineno)
...
def p_func_call11(t):
    '''func_call    : AT ID LPAR params RPAR COLON expr
        ...
        | AT ID'''
    print("func_call_11")
    funcs.check_name(t[2]) or halt("Invalid function name: %s" % t[2], t.lexer.lineno)
